...
const createTemplate = async () => {
  const template = {
    Template: {
      // Template
      TemplateName: "WelcomeBackMailTemplate", // required
      SubjectPart: `Welcome Back to Jacinth Paul Academy, {{name}}!`,
      HtmlPart: `<html>
      <head>
          <style>
              body {
      ...
      <body>
          <div class="container">
              ...
              <p>Dear {{name}}, </p>
              <p>It’s great to see you again! We've been busy making Jacinth Paul Academy even better since you last visited.</p>
              <p>What’s New:</p>
                        <ul>
                        <li>{{newFeaturesList}}</li>
                        </ul>
                        <p>Re-discover what you've been missing <a href="{{dashboardLink}}">{{dashboardLink}}</a></p>
                        <br />
                        <p>Welcome Back, <br>The Jacinth Paul Academy Team</p>
      ...
      TextPart: `Dear {{name}},
                        ...
                        It’s great to see you again! We've been busy making Jacinth Paul Academy even better since you last visited.
                        What’s New:
                        - {{newFeaturesList}}
                        Re-discover what you've been missing: {{dashboardLink}}
                        Welcome Back,
