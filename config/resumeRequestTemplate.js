...
const updateTemplate = async () => {
  const template = {
    Template: {
      TemplateName: "ResumeRequestMailTemplate", // required
      SubjectPart: "We've Received Your Resume Request, {{name}}!",
      HtmlPart: `<html>
      <head>
          <style>
              body {
      ...
      TextPart: `Hello {{name}},
                        ...
                        Thank you for using Jacinth Paul Academy for your career advancement.
