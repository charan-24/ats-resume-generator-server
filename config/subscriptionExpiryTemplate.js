...
const updateTemplate = async () => {
  const template = {
    Template: {
      // Template
      TemplateName: "SubscriptionExpiryNoticeMailTemplate", // required
      SubjectPart: `Your Subscription Has Expired`,
      HtmlPart: `<html>
            <head>
                <style>
                    body {
            ...
            <body>
                <div class="container">
                    ...
                    <p>Dear {{name}}, </p>
                    <p>Your {{subscriptionPlan}} subscription expired on {{expiryDate}}.</p>
                    <p>To regain access to premium features and continue your career journey with us, renew your subscription: <a href="{{renewalLink}}">{{renewalLink}}</a></p>
      ...
      TextPart: `Dear {{name}},
                        ...
                        Your {{subscriptionPlan}} subscription expired on {{expiryDate}}.

                        To regain access to premium features and continue your career journey with us, renew your subscription:{{renewalLink}}
