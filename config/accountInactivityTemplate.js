...
const updateTemplate = async () => {
  const template = {
    Template: {
      TemplateName: "AccountInactivityMailTemplate", // required
      SubjectPart: `We Miss You at Jacinth Paul Academy`,
      HtmlPart: `<html>
      <head>
          <style>
              body {
      ...
      <body>
          <div class="container">
              ...
              <p>Hi {{name}}, </p>
              <p>We've noticed you haven't been around lately, and we miss you! There's a lot happening on Jacinth Paul Academy that you might find interesting:</p>
              <ul>
                        <li>New Job Listings</li>
                        <li>Upcoming Events</li>
                        <li>Resume Building Tools</li>
                        </ul>
              <p>Come back and see what's new <a href="{dashboard}">{{dashboard}}</a></p>
              <br />
              <p>Cheers,<br>The Jacinth Paul Academy Team</p>
                </div>
                <div class="footer">
      ...
      TextPart: `Hi {{name}},
                        ...
                        We've noticed you haven't been around lately, and we miss you! There's a lot happening on Jacinth Paul Academy that you might find interesting:
                        
                        New Job Listings
                        Upcoming Events
                        Resume Building Tools
                        
                        Come back and see what's new {{dashboard}}
